"""
Extension of the GaussianProcessRegressor class from scikit-learn.
The fitting of alpha parameter is added in the training pipeline, i.e.
in this implementation alpha is parameter (not hyperparameter).
"""
...
class HGP():
    ...
    def fit(self, X, y, print_noise_rmse=False):
        ...
        for i in range(self.num_iters):
            ...
            std_estimator = np.log(variance_estimator) #np.sqrt(variance_estimator)
